...
public class EmployeeService implements IEmployeeService {
    ...
    @Override
    public List<EmployeeModel> projectEmployeeRelation(String name) {
        return employeeRepository.findByProjectModelProjectName(name);
    }

    @Override
    public Optional<EmployeeModel> searchEmployeeByName(String name) {
